              ...
              <div class="col-md-12">
                <div class="mb-3">
                  <div class="form-group">
                    <label for="projectw"
                      >Project that your working on<span style="color: red"
                        >*</span
                      ></label
                    >
                    <select
                      class="form-control"
                      v-model="activityRequest"
                      id="projectw"
                ...
                <div class="mb-3">
                  <div class="form-group">
                    <label for="activityRequestDescription"
                      >Request Description<span style="color: red">*</span></label
                    >
                    <textarea
                      name="description"
                      id="activityRequestDescription"
                      class="form-control"
                      v-model="description"
                    ></textarea>
                  </div>
                ...
                <button
                  class="btn btn-primary btn-user mt-4 btn-block"
                  @click="createActivityRequest"
                >
...
export default {
  ...
  methods: {
    ...
    createActivityRequest() {
      ...
      console.log(data);
      axiosInstance.post("earequest/", data).then((data) => {
        console.log(data);
        //clear form here
      });
